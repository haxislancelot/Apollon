...
sleep 0.5
  ...
  ui_print "============================="
sleep 0.5
  ui_print " Apollon v14.0 Revived Version"
sleep 0.1
  ui_print " Haxis | Telegram @haxis_lancelot"
sleep 0.5
  ui_print " Thanks to levv, NDL54 and all my testers."
sleep 0.1
  ui_print "============================="
  ui_print " after reboot, type su enter and su -c boost on terminal ^^"
